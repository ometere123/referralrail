...
export const metadata:Metadata={title:"ReferralRail - referrals that settle on verified work",description:"Referral attribution becomes enforceable economic state on GenLayer.",icons:{icon:"/favicon.svg"}};
