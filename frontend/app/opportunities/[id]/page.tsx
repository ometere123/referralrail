  ...
  <div className="panel action-card">
   ...
   {!wallet.connected?<div className="notice warning">Connect a wallet to see the action available to that address.</div>:
    ...
    <div>
      ...
      {o.state==='JUDGING'&&<div className="notice info"><Hourglass size={15}/> GenLayer is resolving the GitHub evidence. After the judge finalizes, the result is pulled into the settlement contract.</div>}
