...
export default function AppHeader(){
  ...
  return <header className="app-header">
    ...
    <nav className="nav-links"><Link href="/opportunities">Opportunities</Link><Link href="/dashboard">Dashboard</Link><Link href="/protocol">Protocol</Link><Link href="/docs">Docs</Link><Link href="/developers">Developers</Link><Link href="/opportunities/new">Create</Link></nav>
